...
function LoginPage() {
  ...
  return (
    <main className="flex min-h-dvh paper-grid items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md relative">
        <Link
          to="/"
          className="absolute left-2 top-4 flex text-xs items-center"
        >
          <ChevronLeftIcon size={14} />
          Kembali
        </Link>
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-serif">CareerMatch</CardTitle>
          <CardDescription>
            Masuk atau daftar untuk melanjutkan ke dashboard Anda.
          </CardDescription>
        </CardHeader>
