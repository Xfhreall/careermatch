...
import { getDashboardPathForRole, getUserRole } from "../lib/role-routing"
...
export function AuthNavButton() {
  ...
  return (
    <div className="relative flex flex-col items-end gap-1">
      <Button
        className="w-full rounded-3xl border-[#cdb8a3] bg-[#fdf7ef] px-4 py-6 text-[#4a3223] shadow-[0_12px_30px_-24px_rgba(75,48,29,0.55)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-[#f6ebde] md:rounded-full md:py-4"
        disabled={isPending}
