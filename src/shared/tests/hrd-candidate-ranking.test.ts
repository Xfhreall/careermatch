...
} from "@/shared/repository/careermatch/hrd-candidate-ranking"
...
describe("buildAnonymousCandidateMatchRows", () => {
    ...
    const rows = buildAnonymousCandidateMatchRows({
      analyses: [
        ...
        },
        {
          ...
          candidateEmail: "backend@example.com",
          candidateName: "Backend Candidate",
    ...
    expect(rows).toEqual([
      {
        ...
        candidate_email: "backend@example.com",
      ...
      analyses: [
        {
          ...
          candidateEmail: "empty@example.com",
      ...
      analyses: [
        {
          ...
          candidateEmail: "generalist@example.com",
          candidateName: "Generalist Candidate",
          createdAt: "2026-06-17T10:00:00.000Z",
    ...
    expect(rows).toEqual([
      {
        ...
        candidate_email: "generalist@example.com",
        candidate_name: "Generalist Candidate",
  ...
  it("uses unblinded contact data from the webhook payload when available", () => {
    const rows = buildAnonymousCandidateMatchRows({
      analyses: [
        {
          analysisId: "analysis-unblinded",
          candidateProfile: {
            skills: ["React"],
            totalExperienceYears: 3,
          },
          createdAt: "2026-06-17T12:00:00.000Z",
          id: "analysis-row-unblinded",
          jobseekerId: "user-7",
          responsePayload: {
            rawResponse: {
              unblinded_cv: {
                email: "unblinded@example.com",
                name: "Unblinded Candidate",
              },
            },
          },
        },
    ...
    expect(rows).toEqual([
      {
        analysis_result_id: "analysis-row-unblinded",
        candidate_code: "Candidate ANUNBLINDE",
        candidate_email: "unblinded@example.com",
        candidate_name: "Unblinded Candidate",
        job_vacancy_id: "job-unblinded",
